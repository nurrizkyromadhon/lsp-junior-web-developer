...
<body>
    ...
    <div class="container" id="form">
        ...
        <form action="../config/edit.php" method="POST" enctype="multipart/form-data">
            <input type="hidden" value="<?= $hslkeg['id_kegiatan']; ?>" name="id_kegiatan">
            <div class="form-group">
                <label for="judul">Judul Kegiatan:</label>
                <input type="text" class="form-control" id="judul" placeholder="Masukkan Judul Kegiatan" name="judul" value="<?= $hslkeg['judul_kegiatan']; ?>" required>
            </div>
            <div class="form-group">
                <label for="isi_kegiatan">Isi Kegiatan:</label>
                <textarea class="form-control" rows="10" id="isi_kegiatan" placeholder="Masukkan Isi Kegiatan" name="isi_kegiatan"><?= $hslkeg['isi_kegiatan']; ?></textarea>
            </div>
